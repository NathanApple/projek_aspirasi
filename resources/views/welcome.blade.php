                        ...
                        <div class="col-md-6 pr-0">
                            <div class="card-body border-right border-bottom p-3 h-100">
                                <div class="d-flex flex-row bd-highlight pt-2">
                                    ...
                                    <div class="pl-3">
                                        <div class="mb-2">
                                            <a href="https://laravel.com/docs" class="h5 font-weight-bolder text-dark">Buat aspirasi</a>
                                        </div>
                                        <p class="text-muted small">
                                            Buat aspirasi disini
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 pl-0">
                            <div class="card-body border-bottom p-3 h-100">
                                <div class="d-flex flex-row bd-highlight pt-2">
                                    ...
                                    <div class="pl-3">
                                        <div class="mb-2">
                                            <a href="https://laracasts.com" class="h5 font-weight-bolder text-dark">Cek aspirasi</a>
                                        </div>
                                        <p class="text-muted small">
                                            Cek aspirasi kalian disini
                                        </p>
                                    </div>
                                </div>
                            </div>
